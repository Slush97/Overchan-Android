...
/*package*/ class InterceptingAntiDDOS {
    ...
    HttpCookie check(final CloudflareException exception, final ExtendedHttpClient httpClient, final CancellableTask task, final Activity activity) {
        synchronized (lock) {
        ...
        final ExtendedHttpClient.CookieStore cookieStore = httpClient.getCookieStore();
